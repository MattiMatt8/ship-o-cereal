...
urlpatterns = [
    ...
    path("profile/orders/", login_required(views.OrdersListView.as_view()), name="order-history"),
    path("profile/orders/<int:pk>/", login_required(views.OrderDetailView.as_view()), name="order-details"),
]

function getReviewFilled(id, title, stars, review, picture, date, fullName) {
    // Creates html for a new review and fills it out with the information send into it.
    let divTag = document.createElement("div");
    divTag.setAttribute("id", `review-${id}`);
    divTag.setAttribute("class", "flex flex-col my-8 items-center md:flex-row md:items-start md:justify-start");
   ...
   divTag.innerHTML =  `<div class="w-32 md:mr-8">
      ...
      <div class="flex flex-col">
        <div class="">
          ...
          <p id="review-comments-${id}" class="mt-2 text-center italic md:text-left md:mt-4">${review}</p>
        </div>
...
function renderNewReview(data) {
    ...
    document.getElementById("all-reviews").prepend(newReview);
